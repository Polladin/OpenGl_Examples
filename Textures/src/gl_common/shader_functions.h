...
public:
    ...
    {
        std::string vertexShaderSrc = ShaderReader().read( vertexShaderSrcFilePathTex ); // vertexShaderSrcFilePath
        std::string fragmentShaderSrc = ShaderReader().read( fragmentShaderSrcFilePathTex ); // fragmentShaderSrcFilePath 
